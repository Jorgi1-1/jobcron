...
Bot personal que revisa 2x/día las páginas de carreras de una lista de empresas, filtra vacantes relevantes (Frontend/Full-Stack/UX, remoto o CDMX/GDL/MTY/Puebla) y envía un digest diario por correo — sin duplicados y sin costo de infraestructura. Ver [PRD](./PRD-bot-vacantes.md) si lo copias al repo.
...
6. **GitHub Actions** — en el repo (público, para Actions gratis ilimitado):
   ...
   - El workflow [`scraper.yml`](./.github/workflows/scraper.yml) ya corre 2x/día vía cron y también se puede disparar manualmente (`workflow_dispatch`).
